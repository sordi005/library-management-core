...
import com.libraryManagement.dto.BookDTO.UpdateBookDTO;
import com.libraryManagement.dto.MagazineDTO.UpdateMagazineDTO;
...
@JsonSubTypes({
        @JsonSubTypes.Type(value = UpdateBookDTO.class, name = "BOOK"),
        @JsonSubTypes.Type(value = UpdateMagazineDTO.class, name = "MAGAZINE")
})
public abstract class BaseUpdatePublicationDTO {
